...
const UserInformation = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      showSuccessToast(t("settings.userInfo.toastUpdated"))
      toggleEditMode()
    },
        ...
        >
          <FormField
            ...
            render={({ field }) =>
              editMode ? (
                <FormItem>
                  <FormLabel>{t("settings.userInfo.fullNameLabel")}</FormLabel>
                  <FormControl>
                ...
                <FormItem>
                  ...
                  >
                    {field.value || t("settings.userInfo.notSet")}
                  </p>
                </FormItem>
              )
            }
